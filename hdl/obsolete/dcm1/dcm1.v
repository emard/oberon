...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.9_x64\ispfpga\bin\nt64\scuba.exe -w -n dcm1 -lang verilog -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 25.00 -fclkop 75 -fclkop_tol 5.0 -fclkos 375 -fclkos_tol 2.0 -phases 0 -phase_cntl STATIC -fb_mode 1 -bw HIGH -fdc C:/lscc/diamond/3.9_x64/examples/Oberon_SDRAM/dcm1/dcm1.fdc  */
/* Thu Feb 22 10:35:18 2018 */


`timescale 1 ns / 1 ps
module dcm1 (CLKI, CLKOP, CLKOS)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
    ...
    EHXPLLL PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .CLKOS3(), .LOCK(LOCK), .INTLOCK(), .REFCLK(REFCLK), .CLKINTFB())
             /* synthesis FREQUENCY_PIN_CLKOS="375.000000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 375.000000
